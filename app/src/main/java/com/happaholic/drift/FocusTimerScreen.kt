...
fun FocusTimerScreen(
    ...
    if (showEndConfirmation) {
        DriftDialog(
            ...
            description = "This clears your remaining session time.",
            primaryLabel = "Keep focusing",
            onPrimary = { showEndConfirmation = false },
    ...
    if (showSessionEnded) {
        DriftDialog(
            onDismissRequest = {},
            title = "Session ended",
            description = "Your focused minutes were saved.",
    ...
    if (showProtectionInfo) {
        DriftDialog(
            ...
            title = if (sessionStarted) "Focus protection is on" else "Focus protection is ready",
            description = "Leaving Drift automatically ends your session.",
            primaryLabel = "Got it",
            onPrimary = { showProtectionInfo = false },
            informational = true,
        )
    }
    ...
    if (showEarlyBreakMessage) {
        DriftDialog(
            ...
            title = "Give yourself time to settle",
            description = "Breaks unlock after ten focused minutes.",
            primaryLabel = "Continue focusing",
            onPrimary = { showEarlyBreakMessage = false },
        )
    }
}
